...
const HeroSection2 = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row p-8 md:px-16 md:py-20 md:gap-6 lg:gap-3 justify-between bg-[#f6f5f2] mt-6 font-inter">
       {/* {isNavOpen && (
        <div className="fixed top-0 left-0 w-full h-full bg-[#176300] opacity-50 flex lg:hidden -z-30"></div>
      )} */}
