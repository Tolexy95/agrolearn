...
const FounderSection = () => {
    ...
    return (
        <div className={`lg:-mt-44 md:-mt-24 -mt-28 bg-[#f6f5f2] shadow-lg  font-inter '}`} style={{boxShadow: '0px 10px 60px 0px rgba(0, 0, 0, 0.3)' }}>
            <div className="flex flex-col lg:flex-row justify-between gap-20 px-5 md:px-12 lg:py-16">
              
                <div className="flex-1">
                    <h1 className="text-2xl pt-8 lg:text-4xl text-[#255946] font-bold mb-5 font-sora" >Note From Our Founder</h1>
