...
const FounderModal = () => {
    ...
    return (
        <div className="mb-12">
            ...
            <h1 className="text-4xl text-[#255946] font-semibold pb-2 font-sora tracking-wide" >Founder's Note</h1>
            <hr />
            <div className='text-[#6e7673] text-base tracking-wide font-sora my-4' style={{ lineHeight: '2' }}>
                ...
                <p className='mt-4'> AgroHive was founded with the goal of bridging the wide skill gap existing in the agricultural value chain, which is negatively contributing to lower grade agricultural production in Africa, leading to hunger and malnutrition.
