...
//                 {card.iconA && (
//                   <card.iconA className="w-24 h-24 p-2 right-24 -top-[90px]  mb-10 border-8 border-white absolute bg-[#49A760] hover:bg-green-500 rounded-full text-white md:right-32 lg:right-40" />
//                 )}
//                 {card.iconB && (
//                   <card.iconB className="w-24 h-24 p-2 right-24 -top-[90px] mb-10  border-8 border-white absolute bg-[#49A760] hover:bg-green-500 rounded-full text-white md:right-32 lg:right-40"/>
//                 )}
//                 {card.iconC && (
//                   <card.iconC className="w-24 h-24 p-2 right-24 -top-[90px] mb-10 border-8 border-white absolute md:right-32 md:bottom-[330px] lg:right-40 lg:bottom-[250px] bg-[#49A760] hover:bg-green-500 rounded-full text-white"/>
//                 )}
